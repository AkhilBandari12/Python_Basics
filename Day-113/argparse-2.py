...
print("NOTE: Calling the `parse_args()` method on the parser object to access the argument namespace")
print(parser.parse_args())
print()

# The argument switches and the values are expected as a list
print("-- 2. This will print the arguments in the order they're defined via `add_argument`")
